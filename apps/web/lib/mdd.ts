...
export const CATEGORIES: CategoryNode[] = [
  // ─── Women's Western Wear ──────────────────────────────────────────────
  {
    ...
    mandatoryAttrs: [
      ...COMMON_MANDATORY,
      'pattern', 'neck_collar', 'sleeve', 'dress_length', 'dress_shape',
      // dress_shape was previously removed because the production-accepted
      // golden sheet had no Dress Shape column at the time of structural
      // reconciliation. With the move to per-L4 sheet splitting, each L4
      // sheet now has its own column set derived from MDD spec — and MDD
      // explicitly marks dress_shape as applicable to Casual dresses. So
      // dress_shape is restored here and an output column exists for it
      // in GOLDEN_SCHEMA, filtered into the Casual Dresses sheet only.
    ],
  ...
  },
  {
    ...
    sellerSynonyms: [
      'top', 'tops', 't-shirt', 'tshirt', 't shirt', 'tee', 'tees', 'tops & t-shirts',
      'tops and t-shirts', 'graphic t-shirt', 'graphic t shirt', 'crop top', 'cami top',
